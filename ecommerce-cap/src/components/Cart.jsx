...
import getCartTotalPrice from '../utils/cartPrice';
                      ...
                      <li key={product.id} className="flex space-x-6 py-6">
                        ...
                        <div className="flex flex-col justify-between space-y-4">
                          ...
                          <div className="flex space-x-4">
                            <div className="flex border-gray-300 pl-4">
                              <button
        ...
        <section aria-labelledby="summary-heading" className="hidden w-full max-w-md flex-col bg-gray-50 lg:flex">
          ...
          <ul role="list" className="flex-auto divide-y divide-gray-200 overflow-y-auto px-6">
            {cartItems.map((product) => (
              <li key={product.id} className="flex space-x-6 py-6">
                <img
                  src={product.image}
                  className="h-40 w-40 flex-none rounded-md bg-gray-200 object-center"
                />
                <div className="flex flex-col justify-between space-y-4">
                  <div className="space-y-1 text-sm font-medium">
                    <h3 className="text-gray-900">{product.title}</h3>
                  ...
                  <div className="flex space-x-4">
                    <div className="flex pl-4">
                      <button onClick={() => removeFromCart(product.id)} type="button" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                        Remove
                      </button>
                    </div>
                  </div>
          ...
          <div className="sticky bottom-0 flex-none border-t border-gray-200 bg-gray-50 p-6">
            ...
            <dl className="mt-10 space-y-6 text-sm font-medium text-gray-500">
              <div className="flex justify-between">
                <dt>Subtotal</dt>
                <dd className="text-gray-900">{getCartTotalPrice()}</dd>
              </div>
